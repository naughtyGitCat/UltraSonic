...
On first run, an internal SQLite database `ultrasonic.db` will be created at project root (used for file fingerprints). Swagger UI is enabled in development.
